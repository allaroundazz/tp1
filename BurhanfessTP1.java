...
public class BurhanfessTP1 {
    public static void main(String[] args) {
        ...
        countbermain++;
        System.out.println("ketik 0 kalo kamu udah gamau lanjut main: ");
        int maulanjut = minta.nextInt();
        if (maulanjut == 0 ) {
            lanjut = false;
            System.out.println("\n Kamu sudah bermain sebanyak: " + countbermain + "\n");
            System.out.println("\n Terjadi sebanyak " + kesalahan + " Selama kamu bermain");
